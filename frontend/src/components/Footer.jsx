        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Your intelligent admission and campus navigation companion powered by NLP and 360° Virtual Tour technology.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-[#FFFDF0] text-sm">
                ...
                <span>Eastern Mindoro College, Inc.<br />Vicente Ylagan St. Bagong Bayan II, Bongabong, Philippines, 5211</span>
              </li>
        ...
        <div className="border-t border-[#102A71] pt-8">
          <div className="bg-[#102A71] p-4 rounded-lg mb-6">
            <p className="text-[#FFFDF0] text-sm text-center">
              <span className="font-semibold text-[#FFDC5F]">Disclaimer:</span> GabAI is an informational and navigational support tool and does not replace official enrollment systems or procedures.
            </p>
          </div>
